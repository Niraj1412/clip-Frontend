         ...
         <AnimatePresence>
           {videoUrl && !loading && !error && (
             ...
             >
                 ...
                 <div className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] rounded-2xl border border-[#2d2d2d] flex flex-col shadow-2xl flex-1 min-h-0 backdrop-blur-sm h-full">
                  ...
                  <div className="w-full lg:w-[340px] md:w-full sm:w-[320px] flex flex-col gap-2 sm:gap-3 lg:gap-3 min-h-0 h-full">
                        ...
                        <div className="bg-gradient-to-r from-[#252525] to-[#2a2a2a] rounded-xl p-2 sm:p-3 flex items-center justify-between shadow-lg">
                          ...
                          >
                            <FontAwesomeIcon icon={copied ? faCheckCircle : faCopy} className={`text-xs sm:text-sm ${copied ? "text-green-500" : "text-[#6c5ce7]"}`} />
                                                                       ...
                                                                       <div className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] rounded-2xl border border-[#2d2d2d] shadow-2xl flex flex-col min-h-0 flex-1 backdrop-blur-sm h-full">
