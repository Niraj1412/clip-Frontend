  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-[#0f0f1a] py-12">
      ...
      >
        <Link
          to="/"
          className="flex items-center gap-2 text-gray-400 관심 hover:text-white transition-colors px-3 py-2 rounded-lg hover:bg-white/5"
        >
      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSignUp} className="px-8 pb-8">
            <div className="mb-5">
              <label htmlFor="name" className="block text-gray-300 text-sm font-medium mb-2 ml-1">
                Full Name
              </label>
              <div className="relative">
                ...
                <input
                  type="text"
                  id="name"
                  className={`w-full pl-10 pr-4 py-3 bg-[#ffffff0a] border ${
                    formErrors.name ? "border-red-500/50" : "border-[#ffffff1a]"
                  } rounded-lg focus:outline-none focus:border-[#6c5ce7] text-white text-base transition-colors`}
